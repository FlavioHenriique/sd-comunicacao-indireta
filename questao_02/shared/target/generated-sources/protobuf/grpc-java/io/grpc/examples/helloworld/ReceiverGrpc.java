...
public final class ReceiverGrpc {
  ...
  public static final String SERVICE_NAME = "Receiver";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<io.grpc.examples.helloworld.MessageGrpc,
      io.grpc.examples.helloworld.MessageResultGrpc> METHOD_DELIVERY =
  ...
  public static abstract class ReceiverImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void delivery(io.grpc.examples.helloworld.MessageGrpc request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.MessageResultGrpc> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_DELIVERY, responseObserver);
    }
  ...
  public static final class ReceiverStub extends io.grpc.stub.AbstractStub<ReceiverStub> {
    private ReceiverStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    public void delivery(io.grpc.examples.helloworld.MessageGrpc request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.MessageResultGrpc> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_DELIVERY, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ReceiverBlockingStub extends io.grpc.stub.AbstractStub<ReceiverBlockingStub> {
    private ReceiverBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    /**
     */
    public io.grpc.examples.helloworld.MessageResultGrpc delivery(io.grpc.examples.helloworld.MessageGrpc request) {
      return blockingUnaryCall(
          getChannel(), METHOD_DELIVERY, getCallOptions(), request);
    }
  }
  ...
  public static final class ReceiverFutureStub extends io.grpc.stub.AbstractStub<ReceiverFutureStub> {
    private ReceiverFutureStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.helloworld.MessageResultGrpc> delivery(
        io.grpc.examples.helloworld.MessageGrpc request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_DELIVERY, getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DELIVERY:
          serviceImpl.delivery((io.grpc.examples.helloworld.MessageGrpc) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.MessageResultGrpc>) responseObserver);
          break;
        default:
  ...
  private static final class ReceiverDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
      ...
      synchronized (ReceiverGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new ReceiverDescriptorSupplier())
              .addMethod(METHOD_DELIVERY)
              .build();
        }
      }
    }
